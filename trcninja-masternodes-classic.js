/*
 ...
 https://github.com/elbereth/trcninja-fe
...
// TRC Ninja Front-End (trcninja-fe) - Masternode List Classic (v2)
...
var trcversiondefault = "0.12.3.0";
...
$(document).ready(function() {
    ...
    if (trcninjatestnet == 1) {
        ...
        if (typeof trcninjatestnettor !== 'undefined') {
            $('a[name=trcninjatorurl]').attr("href", "http://"+trcninjatestnettor+"/masternodes-classic.html");
            $('span[name=trcninjatordisplay]').show();
        }

        if (typeof trcninjatestneti2p !== 'undefined') {
            $('a[name=trcninjai2purl]').attr("href", "http://" + trcninjatestneti2p + "/masternodes-classic.html");
            $('span[name=trcninjai2pdisplay]').show();
        }
    }
    else {
        if (typeof trcninjator !== 'undefined') {
            $('a[name=trcninjatorurl]').attr("href", "http://"+trcninjator+"/masternodes-classic.html");
            $('span[name=trcninjatordisplay]').show();
        }

        if (typeof trcninjai2p !== 'undefined') {
            $('a[name=trcninjai2purl]').attr("href", "http://" + trcninjai2p + "/masternodes-classic.html");
            $('span[name=trcninjai2pdisplay]').show();
        }
    }
                ...
                if (type != 'sort') {
                    if ((trcninjamndetailvin[trcninjatestnet].length > 0) || (trcninjatxexplorer[trcninjatestnet].length > 0)) {
                        ...
                        for ( var i=0, ien=trcninjamndetailvin[trcninjatestnet].length ; i<ien ; i++ ) {
                            if (ix == 0) {
                                outtxt += '<a href="'+trcninjamndetailvin[trcninjatestnet][0][0].replace('%%a%%',data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex)+'" data-toggle="tooltip" data-placement="left" title="'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'">'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'</a>';
                            }
                            else {
                        ...
                        for ( var i=0, ien=trcninjatxexplorer[trcninjatestnet].length ; i<ien ; i++ ) {
                            if (ix == 0) {
                                outtxt += '<a href="'+trcninjatxexplorer[trcninjatestnet][0][0].replace('%%a%%',data.MasternodeOutputHash)+'" data-toggle="tooltip" data-placement="left" title="'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'">'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'</a>';
                            }
                            else {
