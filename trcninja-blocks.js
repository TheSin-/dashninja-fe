...
$(document).ready(function(){
  ...
  if (typeof trcninjai2p !== 'undefined') {
   ...
   $('#blockstable').on('xhr.dt', function ( e, settings, json ) {
        // Show global stats
        $('#globalsupplyamount').text( addCommas( json.data.stats.global.SupplyAmount) +' '+trcninjacoin[trcninjatestnet] );
        $('#globalmnamount').text( addCommas( json.data.stats.global.MNPaymentsAmount) +' '+trcninjacoin[trcninjatestnet] );
